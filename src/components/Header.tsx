...
interface HeaderProps {
  ...
  activePage: 'upload' | 'editor' | 'download';
  setActivePage: (p: 'upload' | 'editor' | 'download') => void;
  resetAll: () => void;
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 select-none">
            ...
            <span id="header-logo-text" className="font-display font-extrabold text-[22px] tracking-tight bg-gradient-to-r from-[#1a73e8] to-[#1557b0] dark:from-[#8ab4f8] dark:to-[#e3e3e3] bg-clip-text text-transparent">
              ImgRunner
            </span>
        ...
        <nav className="hidden md:flex items-center gap-1 text-sm font-medium">
          <a href="#features" className={`px-3.5 py-1.5 rounded-full transition-colors ${
            theme === 'dark' ? 'text-[#c4c7c5] hover:text-white hover:bg-[#2d2f31]' : 'text-[#444746] hover:text-[#1f1f1f] hover:bg-[#f1f3f4]'
          }`}>{t('nav.features')}</a>
          <a href="#presets" className={`px-3.5 py-1.5 rounded-full transition-colors ${
            theme === 'dark' ? 'text-[#c4c7c5] hover:text-white hover:bg-[#2d2f31]' : 'text-[#444746] hover:text-[#1f1f1f] hover:bg-[#f1f3f4]'
          }`}>{t('nav.presets')}</a>
          <a href="#how" className={`px-3.5 py-1.5 rounded-full transition-colors ${
            theme === 'dark' ? 'text-[#c4c7c5] hover:text-white hover:bg-[#2d2f31]' : 'text-[#444746] hover:text-[#1f1f1f] hover:bg-[#f1f3f4]'
          }`}>{t('nav.how')}</a>
          <a href="#faq" className={`px-3.5 py-1.5 rounded-full transition-colors ${
            theme === 'dark' ? 'text-[#c4c7c5] hover:text-white hover:bg-[#2d2f31]' : 'text-[#444746] hover:text-[#1f1f1f] hover:bg-[#f1f3f4]'
          }`}>{t('nav.faq')}</a>
        </nav>
